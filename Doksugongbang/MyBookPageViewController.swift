//
//  MyBookPageViewController.swift
//  Doksugongbang
//
...
class MyBookPageViewController: UIViewController {
...
extension MyBookPageViewController: UICollectionViewDelegate, UICollectionViewDataSource {
